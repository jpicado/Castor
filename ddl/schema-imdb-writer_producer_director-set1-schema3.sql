CREATE TABLE writer_producer_director_test_neg (
name VARCHAR(250)
);
CREATE TABLE writer_producer_director_test_pos (
name VARCHAR(250)
);
CREATE TABLE writer_producer_director_train_neg (
name VARCHAR(250)
);
CREATE TABLE writer_producer_director_train_pos (
name VARCHAR(250)
);
CREATE TABLE actors (
actid VARCHAR(8),
