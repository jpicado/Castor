CREATE TABLE bigopening_fold1_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold1_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold1_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold1_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold2_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold2_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold2_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold2_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold3_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold3_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold3_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold3_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold4_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold4_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold4_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold4_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold5_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold5_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold5_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold5_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold6_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold6_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold6_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold6_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold7_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold7_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold7_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold7_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold8_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold8_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold8_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold8_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold9_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold9_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold9_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold9_train_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold10_test_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold10_test_pos (
movieid varchar(8)
);
CREATE TABLE bigopening_fold10_train_neg (
movieid varchar(8)
);
CREATE TABLE bigopening_fold10_train_pos (
movieid varchar(8)
);
CREATE TABLE actors (
actid VARCHAR(8),
