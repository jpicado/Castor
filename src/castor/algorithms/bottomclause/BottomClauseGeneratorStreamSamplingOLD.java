...
public class BottomClauseGeneratorStreamSamplingOLD extends BottomClauseGeneratorOriginalAlgorithm {
...
//	private Map<String, Pair<String,String>> typetoRelationAttribute;
	...
	public BottomClauseGeneratorStreamSamplingOLD(int seed, StatisticsStreamSampling statistics) {//, Map<String, Pair<String,String>> typetoRelationAttribute) {
		super(seed);
		this.varCounter = 0;
