package castor.modetransform.main;

import castor.modetransform.helper.ModeGeneratorHelper;
...
public class TransformMain {
    ...
    public String generateModesUsingTranformation(String dataModelFile, String transformSchema) {
        ...
        String result = FileUtils.writeModeToJsonFormat(null, dataModel.getModeH().toString(), modes, dataModel.getSpName(), Constants.FileName.OUTPUT_MODE.getValue());
        if (result.equals("Success"))
            return Constants.FileName.OUTPUT_MODE.getValue();
        return result;
    }
